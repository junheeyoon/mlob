...
import Scatter from '../../Charts/ChartJs/Examples/scatter';
import Bar2 from '../../Charts/ChartJs/Examples/bar';
import {
    AreaChart, Area, Line,
    ResponsiveContainer,
    Bar,
        ...
        return (
            <Fragment>
                <ReactCSSTransitionGroup
                    ...
                    <div>
                        <PageTitle
                            heading="Node Monitoring"
                            subheading="Node Metrics Information Monitoring Page."
                        ...
                        <Row>
                                    ...
                                    <CardHeader className="card-header-tab">
                                        <div className="card-header-title">
                                            ...
                                            <div className="widget-chart p-0">
                                                ...
                                                src={'http://localhost:3000/d-solo/-ZMj5jH7z/node-exporter-quickstart-and-dashboard?orgId=1&theme=light&panelId=2"'} />
                                                </ResponsiveContainer>
                                            </div>
                            ...
                            <Col md="12" lg="6">
                                <Card className="mb-3">
                                    <CardHeader className="card-header-tab">
                                        <div className="card-header-title">
                                            <i className="header-icon lnr-sun icon-gradient bg-tempting-azure"> </i>
                                            Memory Usage
                                        </div>
                                    </CardHeader>
                                            ...
                                            <div className="widget-chart p-0">
                                                ...
                                                <ResponsiveContainer height={250}>
                                                <iframe frameborder={0} height={400} 
                                                src={'http://localhost:3000/d-solo/-ZMj5jH7z/node-exporter-quickstart-and-dashboard?orgId=1&theme=light&panelId=5"'} />
                                                </ResponsiveContainer>
                                            </div>
                        ...
                        <Row>
                            <Col md="12" lg="6">
                                <Card className="mb-3">
                                    <CardHeader className="card-header-tab">
                                        <div className="card-header-title">
                                            <i className="header-icon lnr-cloud icon-gradient bg-tempting-azure"> </i>
                                            Disk I/O
                                        </div>
                                    </CardHeader>
                                            ...
                                            <div className="widget-chart p-0">
                                                ...
                                                <ResponsiveContainer height={250}>
                                                <iframe frameborder={0} height={400}
                                                src={'http://localhost:3000/d-solo/-ZMj5jH7z/node-exporter-quickstart-and-dashboard?orgId=1&theme=light&panelId=6" width="450" height="200"'} />
                                                </ResponsiveContainer>
                                            </div>
                            ...
                            <Col md="12" lg="6">
                                <Card className="mb-3">
                                    <CardHeader className="card-header-tab">
                                        <div className="card-header-title">
                                            <i className="header-icon lnr-diamond icon-gradient bg-tempting-azure"> </i>
                                            Load Average
                                        </div>
                                    </CardHeader>
                                            ...
                                            <div className="widget-chart p-0">
                                                ...
                                                <ResponsiveContainer height={250}>
                                                <iframe frameborder={0} height={400}
                                                src={'http://localhost:3000/d-solo/-ZMj5jH7z/node-exporter-quickstart-and-dashboard?orgId=1&theme=light&panelId=3"'} />
                                                </ResponsiveContainer>
                                            </div>
