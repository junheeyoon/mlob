...
const Signin = lazy(() => import('../../DemoPages/Signin'));
        ...
        <Fragment>
            ...
            <Suspense fallback={
                <div className="loader-container">
                    <div className="loader-container-inner">
                        <h6 className="mt-3">
                            Please wait while we load all the SignIn examples
                            <small>Because this is a demonstration we load at once all the SignIn examples. This wouldn't happen in a real live app!</small>
                        </h6>
                    </div>
                </div>
            }>
